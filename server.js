...
(function() {
  var animal_number, app, connected, consoleRequest, createLogFileName, currentLogFile, endTrial, express, fs, host, interval, io, logData, logDir, logFile, net, nscConnect, nscDisconnect, path, port, sendLogFiles, sendTrialTimeUpdate, server, spawn, startTrial, trialTimeTimer, trial_active, trial_date, trial_length, trial_name, trial_start_time, trial_time, zip;
